...
const Services = () => {
  ...
  return (
    <div className="p-4 customsm:px-0 sm:p-1 smm:p-1 " id="service-sec">
      ...
      <section className="md:w-auto customsm:grid-cols-2  customsm:mt-10 customsm:place-items-center sm:pt-1 smm:mt-3 smm:gap-y-4  sm:gap-y-4 customsm:w-auto  customsm:gap-y-3 smm:grid-cols-2 smm:py-0 smm:w-auto md:gap-y-4 lg:gap-y-4 smm:place-items-center mt-2   sm:place-items-center smm:text-[12px] sm:text-[12px] md:text-[16px]   sm:w-[80%] sm:grid-cols-2 md:grid-cols-3  custom2:w-[90vw] custom:w-[82vw]  custom:text-[16px]  mx-auto py-4 md:place-items-center grid grid-cols-3 grid-rows-2 ">
