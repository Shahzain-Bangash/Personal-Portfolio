  ...
  return (
    ...
    <div className="h-[100vh] w-[100%] landscape:min-h-screen landscape:bg-gradient-to-br landscape:to-[rgb(17, 17, 17)] landscape:from-[rgb(255, 255, 255)] landscape:w-screen landscape:h-auto " id="home-sec box-border">
      ...
      <main className="md:w-[100%] h-[78vh] customsm:w-[100%] mx-auto md:flex sm:w-[100%] customsm:h-[480px]  gap-16 md:gap-[4px] sm:gap-[8px] sm:justify-between sm:ml-0  customsm:text-center custom-[gap-14] sm:flex ">
        <section id="section-1" className="w-[50%] md:w-[65%] lg:w-[80%] sm:w-[60%] custom:w-[50%]   customsm:w-auto  customsm:justify-center smm:text-center smm:w-auto md:text-left ">
        ...
        <div className="text-[2.8rem] font-bold h-[62px] customsm:w-auto ">
          <div className="text-[2.8rem] md:text-[2.8rem] customsm:text-[28px]  smm:text-[34px]  font-bold h-[60px] leading-[62px] relative top-0  sm:text-[32px] sm:leading-12">
            <Typewriter 
              options={{
                strings: [
        ...
        <section className="flex gap-3 mt-10   justify-center customsm:justify-center customsm:mx-auto customsm:w-auto customsm:gap-6  customsm:pt-4 smm:mx-auto md:mx-0 shadow-secondary rounded-md h-24 w-96 md:h-[120px] md:w-[420px] p-3  md:pt-6 border">
          <div
            className="
          pr-4 md:pr-6 customsm:pr-4 leading-[2rem]  relative before:absolute before:content-[''] before:border-l before:border-gray-300 before:right-0 before:h-14"
          >
            <p className="text-[#E46400] text-[1.2rem]">2+</p>
            <h2 className="text-gray-300 customsm:text-[10px]">Experience</h2>
          </div>
          <div className="pr-4 md:pr-6 leading-[2rem] relative before:absolute before:content-[''] before:border-l before:border-gray-300 before:right-0 before:h-14">
            ...
            <h2 className="text-gray-300 customsm:text-[10px]">Project Done</h2>
          </div>
          <div className="pr-4 customsm:pr-0 leading-[2rem]">
            <p className="text-[#E46400] text-[1.2rem]">30+</p>
            <h2 className="text-gray-300 customsm:text-[10px]">Happy Clients</h2>
          </div>
        </section>
